...
class SaCdkAppStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        get_item_func.add_to_role_policy(
            iam.PolicyStatement(
                actions=["dynamodb:GetItem"], resources=[table.table_arn]
            )
        )
        ...
        get_item_integration = apigateway.LambdaIntegration(get_all_func)
        items.add_method("GET", get_item_integration)
        ...
        get_by_course_func.add_to_role_policy(
            ...
            )  # Cloud Watch gave the warning to allow query action
        )
